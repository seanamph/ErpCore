namespace ErpCore.Domain.Entities.InventoryCheck;
...
public class StocktakingTemp
{
    ...
    /// 是否更新 (Y/N)
    /// </summary>
    public string IsUpdate { get; set; } = "N";
    ...
    /// HT自動 (Y/N)
    /// </summary>
    public string HtAuto { get; set; } = "N";
