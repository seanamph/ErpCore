...
using ErpCore.Application.Services.Stocktaking;
using ErpCore.Shared.Common;
using ErpCore.Shared.Logging;

namespace ErpCore.Api.Controllers.Stocktaking;

/// <summary>
/// 盤點維護作業控制器 (SYSW53M)
/// </summary>
[Route("api/v1/stocktaking-plans")]
public class StocktakingPlansController : BaseController
{
    private readonly IStocktakingPlanService _service;

    public StocktakingPlansController(
        ...
        [FromForm] IFormFile file)
    {
        return await ExecuteAsync(async () =>
        {
            await _service.UploadStocktakingDataAsync(planId, file);
            return new object();
        }, $"上傳盤點資料失敗: {planId}");
    }
