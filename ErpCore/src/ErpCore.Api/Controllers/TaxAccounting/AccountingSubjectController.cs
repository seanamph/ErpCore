...
/// <summary>
/// 會計科目維護控制器 (SYST111-SYST11A)
/// 提供會計科目資料的新增、修改、刪除、查詢功能
/// </summary>
[Route("api/v1/tax-accounting/account-subjects")]
public class AccountingSubjectController : BaseController
{
    private readonly ITaxAccountingSubjectService _service;

    public AccountingSubjectController(
        ITaxAccountingSubjectService service,
