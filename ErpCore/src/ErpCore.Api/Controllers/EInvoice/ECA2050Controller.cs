...
/// 電子發票上傳作業控制器 (ECA2050)
/// </summary>
[Route("api/v1/einvoices/eca2050")]
public class ECA2050Controller : BaseController
{
    private readonly IEInvoiceService _service;
    private const string UploadType = "ECA2050";

    public ECA2050Controller(
