...
/// <summary>
/// 會計科目 Repository 實作 (SYSN110)
/// 使用 Dapper 進行資料庫存取
/// </summary>
public class AccountSubjectRepository : BaseRepository, IAccountSubjectRepository
{
    public AccountSubjectRepository(IDbConnectionFactory connectionFactory, ILoggerService logger)
