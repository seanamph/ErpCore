<template>
  <div class="sys0910-query">
    <div class="page-header">
      <h1>使用者查詢功能 (SYS0910)</h1>
    </div>
    ...
    <el-card class="table-card" shadow="never">
      ...
      >
        ...
        <el-table-column prop="UserId" label="使用者代碼" width="120" sortable="custom" />
        ...
        <el-table-column prop="UserType" label="使用者類型" width="120" sortable="custom" />
        <el-table-column prop="ShopId" label="店別代碼" width="120" sortable="custom" />
    ...
    >
      <el-descriptions :column="2" border v-if="detailData">
        <el-descriptions-item label="使用者代碼">{{ detailData.UserId }}</el-descriptions-item>
        ...
        <el-descriptions-item label="使用者類型">{{ detailData.UserType || '-' }}</el-descriptions-item>
        ...
        <el-descriptions-item label="店別代碼">{{ detailData.ShopId || '-' }}</el-descriptions-item>
