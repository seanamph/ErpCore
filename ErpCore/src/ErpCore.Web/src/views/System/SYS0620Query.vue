      ...
      <template #header>
        <div class="header-content">
          ...
          <div class="header-info">
            ...
            <span v-if="queryForm.RoleId">
              角色代碼: <strong>{{ queryForm.RoleId }}</strong>
...
const handleQuery = async () => {
  ...
  await queryFormRef.value.validate(async (valid) => {
    ...
    try {
      ...
      const response = await changeLogsApi.getRoleChangeLogs(queryData)
      ...
      console.error('查詢角色異動記錄失敗:', error)
