<template>
  <div class="sys0650-query">
    <div class="page-header">
      <h1>可管控欄位異動記錄查詢 (SYS0650)</h1>
    </div>
    ...
    <el-card class="search-card" shadow="never">
      <el-form :inline="true" :model="queryForm" :rules="rules" ref="queryFormRef" class="search-form">
        ...
        <!-- 欄位代碼 -->
        <el-form-item label="欄位代碼" prop="FieldId">
          <el-input 
      ...
      <template #header>
        <div class="header-content">
          ...
          <div class="header-info">
            ...
            <span v-if="queryForm.FieldId">
              欄位代碼: <strong>{{ queryForm.FieldId }}</strong>
            </span>
  ...
  await queryFormRef.value.validate(async (valid) => {
    ...
    try {
      const queryData = {
        ...
        FieldId: queryForm.FieldId || undefined,
      ...
      const response = await changeLogsApi.getControllableFieldChangeLogs(queryData)
      ...
      console.error('查詢可管控欄位異動記錄失敗:', error)
