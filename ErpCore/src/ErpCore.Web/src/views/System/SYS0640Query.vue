<template>
  <div class="sys0640-query">
    <div class="page-header">
      <h1>系統權限異動記錄查詢 (SYS0640)</h1>
    </div>
...
const handleQuery = async () => {
  ...
  await queryFormRef.value.validate(async (valid) => {
    ...
    try {
      ...
      const response = await changeLogsApi.getSystemPermissionChangeLogs(queryData)
      ...
      console.error('查詢系統權限異動記錄失敗:', error)
