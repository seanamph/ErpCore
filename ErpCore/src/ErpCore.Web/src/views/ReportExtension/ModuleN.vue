...
const handleSearch = async () => {
  ...
  try {
    ...
    const response = await reportExtensionApi.moduleN.getReports(params)
...
const handleExecuteQuery = async () => {
  try {
    ...
    const response = await reportExtensionApi.moduleN.queryReport(currentReport.value.ReportCode, request)
    if (response.data.success) {
