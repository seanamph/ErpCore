...
const handleSearch = async () => {
  ...
  try {
    ...
    const response = await reportExtensionApi.moduleO.getReports(params)
...
const handleExecuteQuery = async () => {
  try {
    ...
    const response = await reportExtensionApi.moduleO.queryReport(currentReport.value.ReportCode, request)
    if (response.data.success) {
