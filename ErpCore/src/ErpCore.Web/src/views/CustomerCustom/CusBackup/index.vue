<template>
  <div class="cus-backup">
    <div class="page-header"><h1>CUSBACKUP 客戶定制模組</h1></div>
...
const api = {
  getList: (params) => axios.get('/api/v1/cus-backup/data', { params }),
  getById: (tKey) => axios.get(`/api/v1/cus-backup/data/${tKey}`),
  create: (data) => axios.post('/api/v1/cus-backup/data', data),
  update: (tKey, data) => axios.put(`/api/v1/cus-backup/data/${tKey}`, data),
  delete: (tKey) => axios.delete(`/api/v1/cus-backup/data/${tKey}`)
}
