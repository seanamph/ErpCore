<template>
  <div class="lease-extension-management">
    <div class="page-header">
      <h1>租賃擴展維護 (SYS8A10-SYS8A45)</h1>
    </div>
        ...
        <el-row :gutter="20">
          <el-col :span="12">
            <el-form-item label="擴展類型" prop="ExtensionType">
              <el-input v-model="formData.ExtensionType" placeholder="請輸入擴展類型" />
            </el-form-item>
          </el-col>
          <el-col :span="12">
...
export default {
  ...
  setup() {
    ...
    const formRules = {
      ...
      ExtensionType: [{ required: true, message: '請輸入擴展類型', trigger: 'blur' }]
    }

    // 對話框標題
    const dialogTitle = computed(() => {
      return isEdit.value ? '修改租賃擴展' : '新增租賃擴展'
    })
    ...
    const loadData = async () => {
      ...
      try {
        ...
        console.error('查詢租賃擴展列表失敗:', error)
