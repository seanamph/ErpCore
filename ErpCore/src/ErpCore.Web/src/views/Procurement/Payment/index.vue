  ...
  <div class="procurement-payment">
    ...
    <el-card class="table-card" shadow="never">
      ...
      >
        ...
        <el-table-column prop="BankAccountId" label="銀行帳戶" width="150" />
        ...
        <el-row :gutter="20">
          ...
          <el-col :span="12">
            <el-form-item label="幣別" prop="CurrencyId">
              <el-input v-model="formData.CurrencyId" placeholder="請輸入幣別" />
            </el-form-item>
          </el-col>
        </el-row>
        <el-row :gutter="20">
          ...
          <el-col :span="12">
            <el-form-item label="銀行帳戶" prop="BankAccountId">
              <el-input v-model="formData.BankAccountId" placeholder="請輸入銀行帳戶" />
            </el-form-item>
          </el-col>
        </el-row>
        <el-row :gutter="20">
  ...
  setup() {
    ...
    const handleSubmit = async () => {
      ...
      try {
        ...
        if (isEdit.value) {
          const { PaymentId, ...updateData } = formData
          await procurementApi.updatePayment(PaymentId, updateData)
          ElMessage.success('修改成功')
        } else {
          await procurementApi.createPayment(formData)
